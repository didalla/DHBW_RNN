...
\usepackage{amsmath}                  % math environments and \dfrac, \operatorname, etc.
...
\TitelDerArbeit{Rekurrente Neuronale Netze}
\AutorDerArbeit{Luke Vierfuß und Sebastian Höfling}
\Abteilung{-}
...
%	DANKSAGUNG
%
% @stud: acknowledge.tex (Danksagung) bearbeiten
%
%\input{acknowledge}
%\cleardoublepage 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{grundlagen}
\input{probleme}
\input{loesungsansaetze}
%\input{praxisbeispiel}
